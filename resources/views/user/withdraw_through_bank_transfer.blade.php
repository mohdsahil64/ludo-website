							...
							<form action="{{ url('withdraw-now-bank') }}" method="post">
								...
								<div class="row bg-light p-1">
											...
											<div>
												<div>
													...
													<div class="col-12 mb-3 p-0">
														<input type="text" class="form-control" placeholder="Enter Account Holder Name" name="bank_account_holder_name" value="@if(isset($user_bank_details)) {{ $user_bank_details->bank_account_holder_name }}   @endif  " required="">
													</div>
												</div>
												<div>
													...
													<div class="col-12 mb-3 p-0">
														<input type="text" class="form-control" placeholder="Enter Account Number" name="bank_account_number" value="@if(isset($user_bank_details)){{ $user_bank_details->bank_account_number }}   @endif  " required="">
													</div>
												</div>
												<label for="username " class="mr-5"><i class="fa fa-university" aria-hidden="true"></i> IFSC Code</label>
												<div class="col-12 mb-3 p-0">
													<input type="text" class="form-control" placeholder="Enter IFSC CODE" name="ifsc_code" value="@if(isset($user_bank_details)) {{  $user_bank_details->ifsc_code  }}  @endif" required>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="col-12 p-0 mt-2 pt-3">
										<button type="submit" class=" btn-block btn-sm" style="height: 40px; background-color: rgb(15, 125, 44); color: white; border-radius: 21px;">Withdraw</button>
									</div>
									</div>
								</div>
							</form>
